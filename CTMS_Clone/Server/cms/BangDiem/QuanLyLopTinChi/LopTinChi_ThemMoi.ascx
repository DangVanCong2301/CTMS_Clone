<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LopTinChi_ThemMoi.ascx.cs" Inherits="CTMS_Clone.Server.cms.BangDiem.QuanLyLopTinChi.LopTinChi_ThemMoi" %>
<style>
            ...
            <div class="insert__form">
                <div class="">
                    ...
                    <div class="insert__check">
                        ...
                        <label class="insert__check-label">Thêm lớp tín chỉ khác khi thêm lớp tín chỉ này!</label>
                    </div>
                </div>
                <div>
...
<script type="text/javascript">
    ...
    // let subjects = [{ id: 1, name: "Quản trị mạng" }, { id: 2, name: "SQL Server" }, { id: 3, name: "Lập trình hướng sự kiện" }, { id: 4, name: "Lập trình mạng" }, { id: 5, name: "Lập trình cơ sở" }, { id: 6, name: "Giải tích 1" }];
    // let teachers = [{ id: 1, name: "Vũ Xuân Hạnh" }, { id: 2, name: "Trịnh Thị Xuân" }, { id: 3, name: "Lê Hữu Dũng" }, { id: 4, name: "Mai Thị Thuý Hà" }, { id: 5, name: "Nguyễn Thành Huy" }, { id: 6, name: "Nguyễn Văn Hộ" }];
